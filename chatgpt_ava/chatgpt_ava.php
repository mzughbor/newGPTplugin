...
function remove_custom_news($content)
{
    ...
    // related-list1 + feedback-feature  >  is in mawdoo3.com
    // toc id is in mawdoo3.com and inside it there is another are we need to delete
    // references-title class and references class divs...
    ...
    //$divToRemove = $dom->getElementById($divs_ids_to_remove); old way, single case...
